...
export interface UseMazakActionsProps {
  ...
  setScanInputInbox: any;
  scanInputProcess: string;
  setScanInputProcess: any;
  scanInputAdjust: string;
  setScanInputAdjust: any;
  activeScanInput: string;
  setActiveScanInput: any;
  activeTab: any;
  setActiveTab: any;
  setShowActionModal: any;
  setShowPrintModal: any;
  setShowAdjustOrderModal: any;
  setShowRequestNewOrderModal: any;
  setShowLargeSequenceModal: any;
  setShowFreeLabelModal: any;
  selectedAdjustTargetOrder: PlanningOrder | null;
  adjustRequestNote: string;
  setAdjustSubmitting: any;
  setAdjustReason: any;
  setAdjustOrderSearch: any;
  setSelectedAdjustTargetOrder: any;
  setAdjustRequestNote: any;
  ...
  setSavingFreeTemplate: any;
  setFreeLabelTemplateName: any;
  setFreeLabelText: any;
