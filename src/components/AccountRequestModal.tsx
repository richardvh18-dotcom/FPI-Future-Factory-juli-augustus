        ...
        {submitted ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-5">
              {error && (
                <div className="bg-rose-500/20 border-2 border-rose-400/50 p-4 rounded-2xl text-rose-200 text-sm font-bold">{error}</div>
              )}
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button type="submit" disabled={loading}
                  ...
                  {loading ? (
                    ...
                    <><Send size={16} />{t('accountRequest.actions.send', 'Send Request')}</>
                  )}
                </button>
              </div>
            </form>
